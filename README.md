...
**The game is not currently playable and does not enter gameplay yet.**
...
Work is continuing on completing the remaining services and getting the client into a playable game session.
